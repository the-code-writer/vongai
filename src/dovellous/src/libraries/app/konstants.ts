...
const K = {
	...
	ModuleComponentsLibs: {
		firebase: {
			config : {
				apiKey: import.meta.env.VNG_GOOGLE_FIREBASE_API_KEY,
				authDomain: import.meta.env.VNG_GOOGLE_FIREBASE_AUTH_DOMAIN,
				projectId: import.meta.env.VNG_GOOGLE_FIREBASE_PROJECT_ID,
				storageBucket: import.meta.env.VNG_GOOGLE_FIREBASE_STORAGE_BUCKET,
				messagingSenderId: import.meta.env.VNG_GOOGLE_FIREBASE_MESSAGING_SENDER_ID,
				appId: import.meta.env.VNG_GOOGLE_FIREBASE_APP_ID,
